...
const ShopInfoBox = ({ shopInfo, handleOnSave }: ShopInfoBoxProps) => {
  // ใช้ useEffect เพื่ออัปเดต state เมื่อ shopInfo เปลี่ยน (ป้องกันข้อมูลไม่ยอมขึ้นตอนโหลดเสร็จ)
  const [shopData, setShopData] = useState(shopInfo);
  ...
  // ถ้าไม่มีข้อมูลพื้นฐาน ให้แสดง Loading เล็กๆ แทนการปล่อยให้พัง
             ...
             <div>
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full pl-9 pr-3 py-2 bg-gray-50 border border-gray-200 rounded-xl text-xs font-bold focus:ring-2 focus:ring-rose-100 outline-none"
                    />
                </div>
             </div>
             <div>
